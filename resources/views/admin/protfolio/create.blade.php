                                        ...
                                        <div class="body">
                                            <form method="POST" action="{{ route('admin.service.store') }}">
                                                ...
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input value="{{ old('title') }}" name="title" type="text" id="category_name" class="form-control">
                                                        <label class="form-label">{{ __('Title') }}</label>
                                                    </div>
                                                </div>
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input value="{{ old('sub_title') }}" name="sub_title" type="text" id="sub_title" class="form-control">
