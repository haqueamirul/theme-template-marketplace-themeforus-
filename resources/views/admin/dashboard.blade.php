        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-green hover-expand-effect">
                    <div class="icon">
                        <i class="material-icons">{{__('playlist_add_check')}}</i>
                    </div>
                    <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">{{__('TOTAL FAVORITE')}}</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-red hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">{{__('PENDING POSTS')}}</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                    <div class="icon">
                        <i class="material-icons">{{__('person_add')}}</i>
                    </div>
                    <div class="content">
                        <div class="text">{{__('TOTAL VIEWS')}}</div>
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                ...
                <div class="info-box bg-blue-grey hover-zoom-effect">
                    <div class="icon">
                        <i class="material-icons">{{__('labels')}}</i>
                    </div>
                    <div class="content">
                        <div class="text">{{__('TAGS')}}</div>
