                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input value="{{ $about->title }}" type="text" class="form-control" name="title" required>
                                        <label class="form-label">{{__('Review Title')}}</label>
                                    </div>
                                </div>
                                <!-- <div class="form-group form-float">
                                    <div class="form-line">
                                        <input value="{{old('vedio')}}{{ $about->vedio }}" type="text" class="form-control" name="vedio" required>
                                        <label class="form-label">{{__('Vedio Link')}}</label>
                                    </div>
                                </div> -->
                                <div class="form-group form-float">
                                    <div class="form-group">
                                        <img  class="img-responsive img-thumbnail" src="{{ asset('storage/uploads/review/'.$about->image) }}" style="height: 100px; width: 100px;" >
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                              <textarea id="tinymce" name="body">
                                ...
                                <button class="btn btn-primary waves-effect" type="submit">{{__('UPDATE')}}</button>
                            </div>
