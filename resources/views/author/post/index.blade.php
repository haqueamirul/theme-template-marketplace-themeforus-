...
<div class="container-fluid">
    <div class="block-header">
        <h2>
        <a class="btn btn-info" href="{{ route('user.post.create') }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td >
                                        ...
                                        <a href="{{ route('user.post.show',$post->id) }}" class="btn btn-success waves-effect">
                                            <i class="material-icons">{{__('visibility')}}</i>
                                        </a>
                                        <a href="{{ route('user.post.edit',$post->id) }}" title="Edit" class="btn btn-info waves-effect">
