                                        ...
                                        <div class="card">
                                            ...
                                            <div class="body">
                                                <form method="POST" action="{{route('user.profile.update')}}" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    @method('PUT')
                                    <!-- <div class="form-group">
                                        <input type="checkbox" id="publish" class="filled-in" name="seller" value="1" {{ Auth::user()->seller ==  1? 'checked' : ''}}>
                                        <label for="publish">{{__('Author')}}</label>
                                    </div>

                                    <div class="form-group">
                                        <input type="checkbox" id="status" class="filled-in" name="buyer" value="1" {{ Auth::user()->buyer ==  1? 'checked' : ''}}>
                                        <label for="status">{{__('Buyer')}}</label>
                                    </div> -->
                                                    <div class="row clearfix">
                                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
